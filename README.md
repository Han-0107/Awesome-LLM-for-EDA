...
This repo [awesome-LLM4EDA](https://github.com/ai4eda/awesome-LLM4EDA) contains the source for the webpage: [https://ai4eda.github.io](https://ai4eda.github.io), which is a curated paper list of awesome **Large Language Models (LLM) for EDA**.
...
```txt
@article{llm4eda,
  title   = {Awesome LLM for EDA: Breaking Results in Large Language Models for Electronic Design Automation.},
  author  = {Han, Yaohui},
  journal = {llm4eda.github.io},
  year    = {2026},
  url     = {https://llm4eda.github.io/}
}
```
...
## Method 1: send your `bibtex` to us by email
...
## Method 2: Submit a github PR to [https://github.com/ai4eda/awesome-LLM4EDA](https://github.com/ai4eda/awesome-LLM4EDA)



### Step 1: Add your `bibtex` file to `./publications/***.bib`

We provide different categories according to LLM4EDA topics, please copy your bibtex to the corresponding category.

The categories are defined in `pub.yaml` of repo: [awesome-LLM4EDA](https://github.com/ai4eda/awesome-LLM4EDA), you can also submit new categories to `pub.yaml`.
...
categories_publications:
  ...
  categories:
    -
      heading: "Survey & Benchmark"
      file: survey.bib
    -
      heading: "RTL & HDL Code Generation"
      file: rtlgen.bib
    -
    ...
    -
      ...
      file: llm_physical.bib
    -
      heading: "EDA Agents & Automation"
      file: llm_agent.bib
    -
      heading: "Domain-specific Models"
      file: llm_model.bib
```
...
Submit a PR to repo: [awesome-LLM4EDA](https://github.com/ai4eda/awesome-LLM4EDA).
...
See [contributors here](https://github.com/ai4eda/awesome-LLM4EDA/graphs/contributors).