            ...
            if group_by_topic:
                ...
                for pub in pubs:
                    ...
                    if topic_lower not in all_topics:
                        all_topics[topic_lower] = topic.strip()
                    pub['topic_lower'] = topic_lower

                details = ''
                all_topics_pubs = []
                for topic_lower, original_topic in all_topics.items():
                    topic_pubs = []
                    for pub in pubs:
                        if pub['topic_lower'] == topic_lower:
